        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <!-- Logo -->
                    <div class="logo">
                        <h1>@Html.ActionLink("Quiz Lomprayah", "Index", "Home", New With {.area = ""}, New With {.class = "navbar-brand"})</h1>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="row">
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="sidebar content-box" style="display: block;">
                    <ul class="nav">
                        <!-- Main menu -->
                        <li>@Html.ActionLink(" Employee", "Index", "EmployeeInformations", routeValues:=Nothing, htmlAttributes:=New With {.class = "glyphicon glyphicon-home "})</li>
                        <li>@Html.ActionLink(" Employee", "Index", "EmployeeInformations", routeValues:=Nothing, htmlAttributes:=New With {.class = "glyphicon glyphicon-home "})<i class="glyphicon glyphicon-calendar"></i> Calendar</a></li>
                        <li>@Html.ActionLink(" Employee", "Index", "EmployeeInformations", routeValues:=Nothing, htmlAttributes:=New With {.class = "glyphicon glyphicon-home "})<i class="glyphicon glyphicon-stats"></i> Statistics (Charts)</a></li>
    ...
    <footer>
        <div class="container">
            <div class="copy text-center">
                <p>&copy; @DateTime.Now.Year - by Lomprayah</p>
            </div>
        </div>
    </footer>
